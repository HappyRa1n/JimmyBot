...
# ------------------------------StartButtons-----------------------------------
btn_where_is_the_office = types.InlineKeyboardButton(text="Где находится офис?", callback_data="btn_1")
bth_about_company = types.InlineKeyboardButton(text="Расскажи о компании", callback_data="btn_2")
btn_available_vacancies = types.InlineKeyboardButton(text="Расскажи о доступных вакансиях", callback_data="btn_3")
